...
public class AlloyShovelItem extends ShovelItem {
	public AlloyShovelItem(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
		super(material, attackDamage, attackSpeed, settings);
	}

	@Override
	public Text getName(ItemStack stack) {
		Text name = AlloyToolItem.getToolName(stack, "Shovel");
	...
	public void appendTooltip(ItemStack stack, Item.TooltipContext context, TooltipDisplayComponent displayComponent,
		...
		AlloyToolItem.appendToolStats(stack, tooltip, SmeltyToolType.SHOVEL);
